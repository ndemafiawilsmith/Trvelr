            ...
            <div class="row y-gap-40 justify-between xl:justify-start">
                <div class="col-xl-2 col-lg-4 col-sm-6">
                    ...
                    <div class="mt-30">
                        ...
                        <a href="#" class="text-15 fw-500 text-blue-1 mt-5">+(234) 810 050 2093</a>
                    </div>

                    <div class="mt-35">
                        <div class="text-14 mt-30">Need live support?</div>
                        <a href="#" class="text-18 fw-500 text-blue-1 mt-5">hi@trvelr.com</a>
                    </div>
                </div>
                    ...
                    <div class="row x-gap-30 y-gap-10">
                        <div class="col-auto">
                            <div class="d-flex items-center">
                                © 2022 Trvelr LLC All rights reserved.
                            </div>
                        </div>
