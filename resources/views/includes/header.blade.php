        ...
        <div class="row justify-between items-center">
            ...
            <div class="col-auto">
                <div class="d-flex items-center">
                    ...
                    <a href="{{ route('index') }}" class="header-logo mr-30" data-x="header-logo" data-x-toggle="is-logo-dark">
                ...
                <div class="d-flex items-center">
                    ...
                    <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                        <a href="{{ route('become.expert') }}"
                            ...
                            Expert</a>
                        <a href="{{ route('login') }}"
                            class="button px-30 fw-400 text-14 border-white -blue-1 h-50 text-white ml-20">Sign In /
                            Register</a>
                    </div>
                </div>
            </div>
