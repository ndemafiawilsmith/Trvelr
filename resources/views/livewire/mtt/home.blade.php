            ...
            <div class="row justify-center">
                <div class="col-auto">
                    <div class="text-center">
                        ...
                        <h4 data-anim-child="slide-up delay-5" class="text-white mt-6 md:mt-10">
                            Community ID:  FE/24/8194067627 <br>
                            Name: Enebeli Ifechukwu Daniel <br>
                            State: Anambra State <br>
                            Learning Track: AI/ML
                        </h4>
                    </div>
                    ...
                    <button class="tabs__button text-15 fw-500 text-white pb-4 js-tabs-button " data-tab-target=".-tab-item-7">Flights</button>
                        ...
                        <div class="tabs__content mt-30 md:mt-20 js-tabs-content">
                            ...
                            <div class="button-item">
                                <a href="javascripti:void(0)" wire:click='plan'>
                                    <button
